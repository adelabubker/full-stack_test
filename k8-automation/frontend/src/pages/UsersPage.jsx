...
import { Users, Trash2, Search, RefreshCw, Shield } from 'lucide-react';
    ...
    <DashboardLayout>
      <div style={{ animation: 'fadeIn 0.4s ease' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <h1 style={{ fontSize: 'clamp(1.4rem, 4vw, 1.8rem)', fontWeight: '800', marginBottom: '6px' }}>Users</h1>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '12px' }}>
          <div style={{ position: 'relative', maxWidth: '400px', flex: 1, minWidth: '200px' }}>
        ...
        <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-lg)', overflow: 'hidden' }}>
          ...
          <div className="responsive-table-header users-table-header">
            <span>Name</span>
            <span>Email</span>
            <span>Role</span>
            <span>Joined</span>
          ...
          {loading ? (
            ...
            filtered.map((u, i) => (
              <div key={u._id}
                className="responsive-table-row users-table-row"
                style={{
              ...
              >
                ...
                <div>
                  ...
                  <span style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', display: 'block' }}>
                    {u.email}
                  </span>
                </div>
                ...
                {/* Joined */}
                <div>
                  <div className="mobile-label">Joined</div>
