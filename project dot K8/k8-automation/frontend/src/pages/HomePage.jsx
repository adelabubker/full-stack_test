...
const HomePage = () => {
  ...
  return (
    <div style={{ background: 'var(--bg-void)', minHeight: '100vh' }}>
      ...
      {/* ══ SERVICES ══════════════════════════════════════════════════════ */}
      <section style={{ padding: '100px 5%', background: 'var(--bg-void)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', maxWidth: '520px', margin: '0 auto' }}>
              From simple workflow triggers to enterprise AI orchestration — we deliver what scales.
            </p>
          </div>

          {/* Service grid — matches screenshot 3-column cards */}
              ...
              return (
                <div key={s._id}
                  ...
                  style={{
                    ...
                    borderColor: s.featured ? 'var(--gold-border-strong)' : undefined,
                    background: s.featured ? 'linear-gradient(145deg, #161408, #111)' : undefined,
                  }}
                >
                  {s.featured && (
                    <div style={{
                  ...
                  <p style={{
                    color: s.featured ? 'rgba(201,168,76,0.8)' : 'var(--text-secondary)',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '50px', fontSize: '0.82rem', letterSpacing: '0.08em',
                    }}
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '32px', alignItems: 'center' }}>
          <div style={{ gridColumn: 'span 2' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: '1.7', maxWidth: '500px' }}>
              We combine deep technical expertise with practical automation strategy. Every workflow we build is designed for reliability, security, and scale.
            </p>
          </div>
          {[
